...
- `Repo-ready`: the repo contains a concrete deploy path, a concrete validate path, and no committed placeholder values in the claimed route.
...
| Heroku | `heroku stack:set container` with `heroku.yml` + `app.json` | `./scripts/validate-public-deployment.sh --frontend-url <url> --api-base-url <url>` | `Repo-ready` | — |
| Fly.io | `./deploy/fly/deploy.sh` | `./scripts/validate-public-deployment.sh --frontend-url <url> --api-base-url <url>` | `Repo-ready` | — |
...
| Netlify | `netlify deploy` with `netlify.toml` against a chosen backend | `./scripts/validate-public-deployment.sh --frontend-url <url> --api-base-url <url>` | `Repo-ready` | — |
| Vercel | `vercel deploy` with `vercel.json` against a chosen backend | `./scripts/validate-public-deployment.sh --frontend-url <url> --api-base-url <url>` | `Repo-ready` | — |
